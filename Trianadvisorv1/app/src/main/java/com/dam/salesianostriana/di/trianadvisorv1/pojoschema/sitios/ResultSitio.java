package com.dam.salesianostriana.di.trianadvisorv1.pojoschema.sitios;
...
public class ResultSitio {
    ...
    public ResultSitio(String objectId, String nombre, String telefono, Foto foto, String categoria, String direccion) {
