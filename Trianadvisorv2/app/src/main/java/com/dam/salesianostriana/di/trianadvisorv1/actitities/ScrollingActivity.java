...
public class ScrollingActivity extends AppCompatActivity {
    ...
    // Problemas aun por solucionar
    private void loadDataComentarios(final String json){
        final Call<Comentario> comentariosCall = Utiles.pedirServicioConInterceptores().obtenerComentariosSitio(json);
