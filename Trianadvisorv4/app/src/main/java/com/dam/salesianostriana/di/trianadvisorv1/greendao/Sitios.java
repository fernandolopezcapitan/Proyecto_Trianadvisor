...
public class Sitios {
    ...
    public Sitios(String objectId, String updateAt, String nombre, String categoria, String direccion, String tlf, String descripcion, String fotoUrl, String latitud, String longitud) {
        this.objectId = objectId;
        this.updateAt = updateAt;
        this.nombre = nombre;
        this.categoria = categoria;
